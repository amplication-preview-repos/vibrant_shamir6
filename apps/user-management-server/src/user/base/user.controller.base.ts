...
import { ClientProfileFindManyArgs } from "../../clientProfile/base/ClientProfileFindManyArgs";
import { ClientProfile } from "../../clientProfile/base/ClientProfile";
import { ClientProfileWhereUniqueInput } from "../../clientProfile/base/ClientProfileWhereUniqueInput";
...
export class UserControllerBase {
  ...
  async findClientProfiles(
    @common.Req() request: Request,
    @common.Param() params: UserWhereUniqueInput
  ): Promise<ClientProfile[]> {
    const query = plainToClass(ClientProfileFindManyArgs, request.query);
    const results = await this.service.findClientProfiles(params.id, {
      ...query,
      select: {
        createdAt: true,
        id: true,
  ...
  @common.Post("/:id/clientProfiles")
  @nestAccessControl.UseRoles({
    resource: "User",
    action: "update",
    possession: "any",
  })
  async connectClientProfiles(
    @common.Param() params: UserWhereUniqueInput,
    @common.Body() body: ClientProfileWhereUniqueInput[]
  ): Promise<void> {
    const data = {
      clientProfiles: {
        connect: body,
  ...
  @common.Patch("/:id/clientProfiles")
  @nestAccessControl.UseRoles({
    resource: "User",
    action: "update",
    possession: "any",
  ...
  @common.Delete("/:id/clientProfiles")
  @nestAccessControl.UseRoles({
    resource: "User",
    action: "update",
    possession: "any",
  })
  async disconnectClientProfiles(
    @common.Param() params: UserWhereUniqueInput,
    @common.Body() body: ClientProfileWhereUniqueInput[]
  ): Promise<void> {
    const data = {
